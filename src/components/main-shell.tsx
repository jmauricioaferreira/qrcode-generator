import QRGeneratorPage, { QRType } from "./qr-tabs";
import { Logo } from "./images/logo";
import Navigation from "./navigation";
import Nap5kPush from "./nap5kPush";

export default function MainShell({ initialType }: { initialType?: QRType }) {
  return (
    <>
      <Navigation />
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <main className="flex-1 flex flex-col lg:flex-row gap-4 p-2 sm:p-8 lg:p-20 items-stretch">
          ...
          <section
            className="flex-1 flex justify-center lg:h-fit"
            aria-label="Gerador de QR Code"
          >
            <QRGeneratorPage initialType={initialType} />
          </section>
        </main>
        <Nap5kPush style={{ width: 300, minHeight: 50 }} />
